...
import useSignUpUi from '../hooks/use.sign-up-ui';
      ...
      <div className="grid w-full max-w-5xl gap-8 lg:grid-cols-2">
        ...
        <div className="hidden lg:flex lg:flex-col lg:justify-center">
          ...
          <p className="mb-8 text-lg text-muted-foreground">
            Join millions of learners who are mastering new skills and advancing
            their careers.
          </p>
        ...
        <Card className="border-border/50 shadow-lg">
          <CardHeader className="text-center">
            ...
            <CardDescription>
              Get started with free access to thousands of courses
            </CardDescription>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <MessageCircleMoreIcon className="absolute left-3 top-1/2 h-4 w-4 -translate-y-1/2 text-muted-foreground" />
                  <Input
                    id="bio"
                    type="text"
                    placeholder="I'm full of passion to learn more..."
                    {...register('bio')}
                    className="pl-10"
